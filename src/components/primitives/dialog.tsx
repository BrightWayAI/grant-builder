 ...
 * Modal dialogs with overlay, animations, and accessible keyboard navigation.
 */
    ...
    >
      ...
      <DialogPrimitive.Close
        className={cn(
          ...
          "rounded-sm opacity-70 ring-offset-surface-card",
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn(
      "font-display text-xl font-semibold leading-snug tracking-tight text-text-primary",
      className
    )}
    {...props}
  />
